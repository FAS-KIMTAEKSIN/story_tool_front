...
const SimilarContainer = styled.div`
  ...
  margin: 1rem 0;
  max-height: ${(props) =>
    props.isOpen ? '500px' : '0'}; /* 열림/닫힘 상태에 따라 높이 조정 */
  overflow: hidden; /* 닫힘 상태에서 내용 숨기기 */
...
const MobileResult = () => {
  ...
  const [isOpenSimilar, setIsOpenSimilar] = useState(false) // SimilarContainer의 열림/닫힘 상태 관리
    ...
    <MobileWrapper>
      {isLoading ? (
        ...
        <>
          ...
          {/* 유사한 고전 단락 섹션 ⓘ*/}
          <SimilarHeader onClick={toggleOpen}>
            유사한 고전 단락보기
          </SimilarHeader>
          <SimilarContainer isOpen={isOpenSimilar}>
